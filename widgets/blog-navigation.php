...
class AMBBlogNavigationWidget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		?>
		<ul>
			<li><a href="<?php echo get_home_url(), '/archives/' ?>"><?php _e('Archives', 'amoeba'); ?></a>
			<li><a href="<?php echo get_home_url(), '/categories/' ?>"><?php _e('Categories', 'amoeba'); ?></a>
			<li><a href="<?php echo get_home_url(), '/tags/' ?>"><?php _e('Tags', 'amoeba'); ?></a>
		</ul>
		<?php
